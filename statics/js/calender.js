...
Calendar.prototype.nextMonth = function () {
    ...
    }, 200), document.querySelector(".root").setAttribute("data-theme", this.Months[document.querySelector('[data-active="true"] .render').getAttribute("data-month")].toLowerCase())
    ...
    if ("FF" == myBrowser()) {
        var doms = document.getElementsByClassName("table");
        for (var i = 0; i < doms.length; i++) {
            doms[i].style.cssText = "font-size:0.9rem";
        }
    }
